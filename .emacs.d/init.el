...
(setq-default
 ...
 completion-auto-help t                           ; Automatically provide help for invalid completion input
 completion-auto-select 'second-tab               ; Use the second tab to start completion in the buffer
 ...
 completion-show-help nil                         ; Don't show help
 completions-format 'one-column                   ; Show completions in one column
 completions-max-height 10                        ; Don't have a really high completion window
 completions-sort 'historical                     ; Sort completions by history
 completions-styles '(partial-completion flex initials)
 ...
 minibuffer-depth-indicate-mode t                 ; Show the depth of nested minibuffer
 minibuffer-electric-default-mode t               ; Automatically enter default value in minibuffer
...
(use-package bbdb
  ...
  (bbdb-message-ignore-mail-re
   "\\`\\(?:reply[+][^@]+@mg1\\.substack\\.com\\|notifications@github\\.com\\)\\'")
