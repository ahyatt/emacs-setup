...
#+end_src
*** Eglot
Eglot is very useful to connect to LSP clients.  However, I can't get it to not crash on startup.
#+begin_src emacs-lisp
(use-package eglot
  :disabled t
...
#+end_src
*** LSP
I've had some issues getting Eglot to work, and LSP seems to have more features,
