...
#+END_SRC
** Input method
The TeX input method is really cool and super flexible.
#+begin_src emacs-lisp
...
*** Org contrib
I basically just use this for =org-checklist=.
#+begin_src emacs-lisp
...
#+end_src
*** Org UI tweaks
Use svg tags, they are pretty!  Except it doesn't work at all.  May need more tweaking.
#+begin_src emacs-lisp
